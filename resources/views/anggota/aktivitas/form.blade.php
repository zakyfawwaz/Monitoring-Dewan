        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ isset($aktivitas) ? route('anggota.aktivitas.update', $aktivitas) : route('anggota.aktivitas.store') }}" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12"><label class="form-label fw-semibold" style="font-size:.85rem">Dokumentasi Foto</label><input type="file" name="dokumentasi_foto" class="form-control" accept="image/*"></div>
                </div>
