...
@section('page-title', 'Aktivitas Harian')
@section('content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <p class="text-muted mb-0" style="font-size:.85rem">Kelola aktivitas harian seluruh anggota dewan</p>
    <a href="{{ route('admin.aktivitas.create') }}" class="btn btn-success btn-sm px-3" style="border-radius:8px"><i class="bi bi-plus-lg me-1"></i> Tambah Aktivitas</a>
</div>
...
<div class="card-clean card mb-3">
    <div class="card-body py-2 px-3">
        <form method="GET" class="row g-2 align-items-center">
            ...
            <div class="col-auto"><a href="{{ route('admin.aktivitas.index') }}" class="btn btn-outline-secondary btn-sm">Reset</a></div>
        </form>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex gap-1 justify-content-center">
                                    <a href="{{ route('admin.aktivitas.edit', $akt) }}" class="btn btn-outline-warning btn-sm"><i class="bi bi-pencil"></i></a>
                                    <form action="{{ route('admin.aktivitas.destroy', $akt) }}" method="POST" class="m-0 p-0" onsubmit="return confirm('Hapus aktivitas ini?')">
                                        @csrf @method('DELETE')
